...
def build_parser() -> argparse.ArgumentParser:
    ...
    decode.add_argument("--ruleset-dir", default="", help="Directory containing SerialDecodeRule.csv/ModelDecodeRule.csv")
    ...
    gap.add_argument("--ruleset-dir", required=True, help="Directory containing SerialDecodeRule.csv/AttributeDecodeRule.csv")
    ...
    phase3.add_argument("--ruleset-dir", required=True, help="Ruleset dir containing SerialDecodeRule.csv/AttributeDecodeRule.csv")
    ...
    phase3_mine.add_argument("--ruleset-dir", required=True, help="Ruleset dir containing SerialDecodeRule.csv/AttributeDecodeRule.csv")
